    ...
    public void guardar() {
        try {
            ...
            if (this.enAgregar) {
                ...
                FacesUtil.addMessageInfo("Se agrego el Historial: " + this.historialEstacion.getCodigo());
            } else {
                this.historialEstacionService.modificar(historialEstacion);
                FacesUtil.addMessageInfo("Se modific\u00f3 el Historial con c\u00f3digo: " + this.historialEstacion.getCodigo());
            }
        } catch (Exception e) {
